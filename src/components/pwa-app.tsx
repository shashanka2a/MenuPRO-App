...
import { PaymentSuccessScreen } from "./pwa/payment-success-screen";

export type Screen = 'onboarding' | 'qr-scan' | 'menu' | 'item-detail' | 'cart' | 'payment-success';
...
export function PWAApp() {
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      ...
      case 'qr-scan':
        return <QRScanScreen onScanComplete={() => navigateToScreen('menu')} />;
      case 'menu':
      ...
      case 'cart':
        return <CartScreen 
          ...
          onBack={() => navigateToScreen('menu')}
          onCheckout={() => navigateToScreen('payment-success')}
        />;
